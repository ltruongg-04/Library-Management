    ...
    <div className="mb-6 flex flex-wrap items-center gap-4 rounded-xl border border-surface-container-high bg-white p-2 shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-3 pr-2">
        ...
        <div className="relative">
          <select
            className="flex appearance-none items-center gap-2 rounded-lg border border-surface-container-high pl-3 pr-8 py-1.5 text-[14px] font-medium text-on-surface hover:bg-surface focus:outline-none focus:ring-2 focus:ring-primary-500/20 bg-transparent disabled:opacity-50"

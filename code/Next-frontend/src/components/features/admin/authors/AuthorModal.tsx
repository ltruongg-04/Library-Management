        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[13px] font-medium text-on-surface-variant">Tên tác giả *</label>
              <input 
                type="text" 
                required 
                value={name}
            ...
            <div className="space-y-1.5">
              <label className="text-[13px] font-medium text-on-surface-variant">Tiểu sử</label>
              <textarea 
                value={description}

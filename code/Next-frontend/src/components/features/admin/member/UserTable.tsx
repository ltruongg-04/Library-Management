            ...
            <div className="flex min-h-[400px] flex-col overflow-y-auto">
                {loading ? (
                    Array.from({ length: 5 }).map((_, idx) => (
                        <div key={idx} className="grid grid-cols-12 items-center gap-4 border-b border-surface-variant p-md">
                            <div className="col-span-12 flex items-center gap-3 sm:col-span-4 md:col-span-3 lg:col-span-3">
                            ...
                            <div className="col-span-8 hidden items-center sm:flex md:col-span-4 lg:col-span-3">
                                <Skeleton className="h-4 w-40" />
                            </div>
                            <div className="col-span-12 hidden items-center md:col-span-2 md:flex">
                                <Skeleton className="h-6 w-20 rounded-full" />
                            </div>
                            <div className="col-span-6 hidden items-center lg:col-span-2 lg:flex">
                                <Skeleton className="h-4 w-20" />
                            </div>
                            <div className="col-span-6 hidden items-center justify-end lg:col-span-1 lg:flex">
                                <Skeleton className="h-4 w-24" />
                            </div>
                            <div className="col-span-12 flex items-center justify-end gap-2 sm:col-span-4 md:col-span-3 lg:col-span-1">

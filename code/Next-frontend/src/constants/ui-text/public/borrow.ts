export const BORROW = {
    ...
    LOAN_DETAIL: {
        ...
        SETTLEMENT_COLLECT: "Cần thanh toán thêm:",
        SETTLEMENT_REFUND: "Dự kiến hoàn lại:",
        SETTLEMENT_SETTLED: "Hoàn tất thanh toán",
    ...
    TRA_CUU: {
        ...
        METHOD_ORDER_CODE: "Theo Mã đơn",
        METHOD_EMAIL: "Theo Email",
        SEARCH_LABEL_ORDER: "Mã đơn mượn",
        SEARCH_PLACEHOLDER_ORDER: "VD: BO-123456",
        SEARCH_LABEL_EMAIL: "Địa chỉ Email",
        SEARCH_PLACEHOLDER_EMAIL: "VD: email@example.com",
        ORDER_CODE_LABEL: "Mã đơn mượn",
        OTP_LABEL: "Mã xác thực (OTP)",
        OTP_PLACEHOLDER: "Nhập mã 6 số gửi tới email",
        OTP_SENT: "Mã OTP đã được gửi tới email của bạn. Vui lòng kiểm tra hộp thư.",
        SEARCH_BTN: "Tra cứu",
        SEND_OTP_BTN: "Lấy mã OTP",
